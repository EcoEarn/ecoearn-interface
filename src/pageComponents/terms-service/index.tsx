    ...
    <div className={styles.content}>
      <article>
        ...
        <p>
          ...
          <a href="https://ecoearn.io/" target="_blank" rel="noreferrer">
            https://ecoearn.io/
          </a>{' '}
          {`(the "Website ")`} and any subdomains associated with the Website. You should read these
          Terms carefully as it forms a contract between you and EcoEarn and governs your use of the
          Website. Please note that by accessing, browsing or otherwise using the Website, or by
          acknowledging agreement to the Terms of Service and the{' '}
          <a href="/privacy-policy" target="_blank">
            Privacy Policy
          </a>
          , you are accepting and agreeing to these Terms of Service and the policies and guidelines
          referenced in these Terms of Service. If you do not agree, you are not authorized to
          access or use the Website and should not use the Website.
        </p>

        <p className="font-bold py-10">
          NOTICE: The Website is only available to you — and you should only access the Website — if
          you agree completely with these terms. Any claim, dispute, or controversy of any nature
          arising out of these Terms must be resolved by final and binding arbitration in accordance
          with the requirements described in Section 13.
        </p>
        ...
        <section>
          ...
          <p>
            ...
            “us,”, or “our,”) concerning your use of our Site (as defined in clause 1.4). You are
          ...
          <p>
            ...
            incorporated by clause 1.11, below) constitute the sole and entire agreement between you
            and EcoEarn and supersede all prior and contemporaneous understandings between the
            parties on your use of the Site. Any additional terms, conditions, licenses,
            limitations, disclaimers and obligations contained within and on the Site are
            incorporated into these Terms of Service by reference, including the Privacy Policy. You
          ...
          <p>
            ...
            available through each of the following:
          </p>
          <ol className={styles['lower-alpha']}>
            <li>
              ...
              or any subdomain thereof controlled by us (the “Website”);
            </li>
            <li>
              Other communication by us on infrastructure not operated by us including accounts on
              social media platforms (such as Twitter, Facebook, YouTube, Medium and the like) and
              communication tools (such as Discord and Telegram) and other public forums moderated
          ...
          <p>
            ...
            and limitations set forth in these Terms may not apply in full to specific Users. The
          ...
          <p>
            ...
            beginning of these Terms of Service will reflect the last date when such amendments are
            made, which shall be effective immediately, unless explicitly stated otherwise. It is
            your responsibility to check these Terms of Service and remain informed of any
            amendments as long as you continue accessing or using the Site or any Services. If you
            disagree with these Terms of Service or with any subsequent amendments, changes, or
            updates, you may not use the Site or any of the Services; your only recourse in the case
            of disagreement is to stop accessing the Site. In the event of any inconsistency between
          ...
          <p>
            ...
            would be contrary to law or regulation, such as applicable sanctions, or require us to
            hold any special licence or registration within your jurisdiction. We make no claims
            that the Site or any of its content or features are accessible or appropriate in the
            user’s jurisdiction. Access to the Site may not be legal by certain persons or in
            certain countries. If you access the Site, you are solely responsible for ensuring that
          ...
          <p>
            ...
            U.S. Government embargo/trade sanction, and (b) you are not identified as a Specially
            Designated National or placed on any U.S. Government list of prohibited, sanctioned, or
          ...
          <ol className={styles['lower-alpha']}>
            <li>
              ...
              , which governs our use of any personal data we collect about you or you provide to
              us, and, under which you consent to our use of your personal information and warrant
              that all data you provide is accurate (our “Privacy Policy”);
            </li>
            <li>
              Any applicable terms, disclosures, and other documents that may be posted on the Site
              from time to time; and
            </li>
            <li>
              Any other terms and conditions to which you may separately agree and govern your use
              of the software, products, services, content, tools and market data provided through
              the Site.
            </li>
          </ol>
          ...
          <p>
            ...
            component of the Site. On the other hand, any reference to an “account” in these Terms
            of Service is completely unrelated to your connection and therefore accounts with any
            Social Media, or any Wallet you may hold or interact with through EcoEarn.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            ...
            Social Media or Third Party Products (as defined in clause 4.5). As a user of the Site,
            you agree not to do any of the following:
          </p>
          <ol className={styles['lower-alpha']}>
            <li>
              Make any unauthorised use of the Site, such as collecting other users’ usernames or
              email addresses to send unsolicited communications or creating user accounts
              (including any accounts when using Social Media) under false pretences;
            </li>
            <li>
              Systematically retrieve data or other content from the Site or users of the Site to
              compile a database or directory without our written permission;
            </li>
            <li>
              Circumvent, disable, or otherwise interfere with our Site’s security-related features,
              including features that prevent or restrict using or copying any Site-related data or
              content or enforce limitations on their use or copy;
            </li>
            <li>
              Use any Site information or features to bully, stalk, harass, abuse, assault, or harm
              any person, group or organization;
            </li>
            <li>
              Use any Site information or features in any effort to compete with us, create your own
              revenue-generating endeavour or commercial enterprise, or offer any substitute for any
              of the products, services or features we offer, either within or outside the Site;
            </li>
            <li>
              Harass, annoy, intimidate, or threaten any other Site user or any of our employees,
              agents, contractors, partners, or suppliers;
            </li>
            <li>
              Delete the copyright or other proprietary rights notice from your replication or use
              of any information or other content available on or through the Site;
            </li>
            <li>
              Decipher, decompile, disassemble, or reverse engineer any of the software comprising
              or in any way making up any part of the Site;
            </li>
            <li>
              Upload or transmit (or attempt to upload or transmit) any information, code, or other
              materials that function as a mechanism for passive or active information collection,
              including but not limited to clear graphics interchange formats (or GIFs), 1×1 pixels,
            ...
            <li>
              ...
              material that interferes with any person, organization, or group’s uninterrupted use
              and enjoyment of the Site;
            </li>
            <li>
              Use, launch, or engage in any automated use of the Site’s system, such as using
              scripts to send comments or messages, robots, scrapers, or offline readers, or
              deploying similar data gathering or extraction tools;
            </li>
            <li>
              Disparage, tarnish, or otherwise harm the Site, or us or our agents, employees,
              partners, or suppliers, or use the Site to violate other persons’ privacy or other
              legal rights;
            </li>
            <li>
              Use the Site in a manner inconsistent with, or that violates, any applicable law or
              regulation;
            </li>
            <li>
              Trick, defraud, or mislead us and other Site users, especially in any attempt to learn
              sensitive account information, such as user passwords or other credentials;
            </li>
            <li>
            ...
            <li>
              Interfere with, disrupt, or create an undue burden on any component of the Site or
              networks connected to the Site;
            </li>
            <li>
              Attempt to impersonate another user or person, use the username or credentials of
              another user, or impersonate or attempt to impersonate EcoEarn or any EcoEarn agent or
              employee (including, without limitation, by using any associated email addresses or
              usernames);
            </li>
            <li>Use the Site to advertise or sell goods and services;</li>
            <li>
              Access or attempt to access any part of the Site that you are restricted from
              accessing;
            </li>
            <li>Misrepresent your or any other Site user’s experience, skills, or information;</li>
            <li>
              Falsely imply a relationship with us or another company with whom you do not have a
              relationship.
            </li>
            <li>
              Engage in any overtly discriminatory, racist, sexist, misogynistic, objectifying,
              homophobic, or transphobic act or permeate any other form of bigotry or hatred;
            </li>
            <li>
              Act in any way to release personal information, including real-world information about
              other users or any EcoEarn agents or employees;
            </li>
            <li>
              Engage in, advocate for, or induce any act that would be deemed illegal in any
              jurisdiction to which you may be subject, including but not limited to any theft,
              aggravated sexual act, self–harm, insurrection, property damage, violent act,
              intimidation, libel, or other harm;
            </li>
            <li>
              Expose any person under 18 years old to dangerous situations, including but not
              limited to grooming, inappropriate content, or sexualization (regardless of
              jurisdiction); or
            </li>
            <li>
              Impersonate or attempt to impersonate any other person (using an email address, name,
          ...
          <p>
            ...
            connected to the Site and (b) making any modifications, adaptations, additions, or
            enhancements to the Site or our Site Content for any reason (including error
            correction), including the modification of the paper or digital copies you may have
            downloaded.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            and your use of the Site. You alone are responsible for any unauthorised access to and
            use of your accounts and credentials, and you accept all risk resulting from any other
            access to or use of (whether authorised or unauthorised) the Site or related third-party
            services, to the maximum extent permitted by law. You agree to use the Site for purposes
          ...
          <p>
            ...
            third-party applications. You represent and warrant that you are familiar with and
            accept the risks associated with digital applications, digital identity, private keys,
            and the importance of keeping these secure, and other related risks.
          </p>
        </section>
        <section>
          <h2>5. Our Content</h2>
          ...
          <p>
            ...
            functionality, software, website designs, audio, video, text, photographs, logos, and
            graphics available on, through, or in connection with any part of the Site (altogether,
            “Site Content”). Except where specifically attributed to someone else, we own all
            necessary moral, proprietary, and licensing rights related to Site Content, which is
            protected by copyright, trademark, and other applicable intellectual property laws and
            international conventions all around the world. You are not permitted to use our
          ...
          <p>
            ...
            third parties (the “Open Source Code”). Your use of any Open-Source Code or any
            components of our Site is not subject to the provisions of these Terms and Conditions
            but, instead, is subject to the licence terms accompanying the Open-Source Code. Nothing
          ...
          <p>
            ...
            display, encode, translate, transmit, distribute, sell, licence, or otherwise
          ...
          <p>
            ...
            through third-party integrations and links to other websites (collectively, “Third-Party
            Products”). Third-Party Products may be governed by separate agreements or licences with
            those third parties. We offer no guarantee and assume no responsibility or liability of
            any kind for Third-Party Products or their providers, including but not limited to your
            use of any content or features available through third-party sites. You understand and
            agree that you are responsible for the consequences of your use of any Third-Party
            Products, and that we bear no responsibility or liability for Third-Party Products or
          ...
          <p>
            ...
            relation to your use of any Site Content. All other information, services, or features
            of third parties (whether available through our Website, on any Social Media, or by
            other means) is also for informational and educational purposes only. No party of any
            Site Content or third-party content should be construed as an endorsement by EcoEarn to
            use any part of the Site or any products or services whatsoever. No Third-Party Products
            should be considered an endorsement of EcoEarn. To the extent you use Third-Party
          ...
          <p>
            ...
            a way that constitutes infringement of your intellectual property rights, then please
            provide us with written notice via mail or email (as specified in clause 1.3). Upon
          ...
          <p>
            ...
            Content is accurate, complete, or up to date. The Site is provided to you AS IS and AS
            AVAILABLE, with all faults. We expressly disclaim all liability for any inaccuracies in
            the Site, Site Content, or information processed through our systems or provided by any
            third party. We disclaim all warranties, express or implied, with respect to the Site,
            Site Content, and Third-Party Products including but not limited to any warranty of
            fitness for a particular purpose, merchantability, or good and workmanlike product or
            service. Additionally, we do not guarantee our Site will be secure or free from bugs,
            viruses, or other malware. You should not interpret any Site Content or any
            communications from us as advice of any kind, including but not limited to financial
            advice. You should seek professional or specialist advice before you ever consider
            acting or not acting on the basis of any Site Content. We are not liable for any errors
            in actions taken in reliance Site Content or any communications you may receive from us,
            including with respect to the release of any tokens or funds.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            non-sublicensable right and license to use and exploit any User Content in any form. We
            retain the unlimited right and exclusive discretion to copy, reproduce, fix, modify,
            adapt, translate, reformat, prepare derivatives of, manufacture, publish, distribute,
            sell, licence, transfer, lease, or transmit any User Content. We also reserve the right
        ...
        <section>
          ...
          <ol className={styles['lower-alpha']}>
            ...
            <li>
              Take appropriate legal action against anyone who, in our sole discretion, violates any
              applicable laws or these Terms of Service, including without limitation, reporting
              such user to law enforcement authorities;
            </li>
            <li>
              In our sole discretion and without limitation, disable access to the Site to address
              any hacks, exploits, system vulnerabilities, or anything that is in any way a burden
              to our systems; and
            </li>
            <li>
          ...
          <p>
            ...
            warranties under clause 4.8. We may experience hardware, software, or other problems or
            need to perform maintenance related to the Site, which may result in interruptions,
            delays, or errors. You agree that we have no liability whatsoever for any loss, damage,
            or inconvenience caused by your inability to access or use the Site during any downtime
            or discontinuance of the Site. We are not obligated to maintain and support the Site or
        ...
        <section>
          ...
          <p>
            ...
            details. Our use of your personal information is subject to the terms of our Privacy
          ...
          <p>
            ...
            from you or your device and use it to inform our Site’s continued development.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            liability or responsibility for any breach of security unless it is due to our gross
            negligence. Any information you send or receive while using the Site may not be secure
            and may be intercepted or later acquired by unauthorised parties. Your use of the Site
            and any related features or tools is at your own risk. You accept that in using any of
            the Site, Wallet or Chain, you are additionally subject to and understand and accept all
            other associated risks such as ownership expectations, technology risk, token risk and
          ...
          <p>
            ...
            or personal injury caused by our negligence or the negligence of our employees, agents,
            or contractors, or for fraud or fraudulent misrepresentation. We will not be responsible
            or liable to you for any losses you incur resulting from your use of the Site, your
            Wallet (if applicable), any other wallet (whether or not accessible from our Site) or
            any third-party dApps (whether or not accessible from our Site). To the extent permitted
            by law, we will not be responsible for any loss or damage, whether in contract, tort
            (including negligence), breach of statutory duty, or otherwise, even if foreseeable,
            arising under or in connection with your use of, or inability to use, our Site, or with
            your use of or reliance on any content displayed or otherwise obtained on or through our
            Site. Our exclusion from liability includes but is not limited to the following:
          </p>
          <ol className={styles['lower-alpha']}>
            ...
            <li>
              Any damage suffered from unauthorised access or activities by third parties, including
              the use of viruses, phishing, brute forcing, or other means of attack against the
              Site, the Chain, or your Wallet;
            </li>
            <li>
              Any user error, such as forgotten private keys or incorrectly construed smart
              contracts or other transactions;
            </li>
            <li>Any server failure or data loss, including loss of private keys;</li>
          ...
          <p>
            ...
            resulting from your use of our Site for any commercial or business purposes. As a
            consumer, you may have legal rights in specific jurisdictions in relation to goods that
            are faulty or not as described. Nothing in these Terms of Service will affect these
            legal rights.
          </p>
        </section>
        <section>
          ...
          <ol className={styles['lower-alpha']}>
            <li>
              Any registration information you submit is and will be true, accurate, current, and
              complete;
            </li>
            <li>
              You will maintain the accuracy of your information and promptly update your
              registration if your information changes or as otherwise necessary;
            </li>
            <li>
              You have the legal capacity, and agree, to comply with these Terms of Service,
              including that you are at least 18 years old and will not access the Site through
          ...
          <p>
            ...
            all current or future access to and use of the Site (or any part of the Site) at any
            time in our sole discretion, with or without notice, without incurring liability of any
            kind.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            against any loss, damage, liability, claim, or demand, including for reasonable
            attorneys’ fees, made by third party arising from any of the following:
          </p>
          <ol className={styles['lower-alpha']}>
            <li>
              Your use of the Site, and any unauthorised use of any of your accounts or credentials
              to access and use the Site;
            </li>
            <li>
              Your breach of these Terms of Service or your representations and warranties set forth
              in these Terms of Service.
            </li>
            <li>
              Your violation of the rights of any third party, including but not limited to
          ...
          <p>
            ...
            fully cooperate, at your expense, with our defence of any related claims. We will use
            reasonable efforts to notify you of any such claim, action or proceeding which is
            subject to this indemnification upon becoming aware of it. Our indemnity under this
            Section 10 is in addition to, and not in lieu of, any other indemnities set forth in any
        ...
        <section>
          ...
          <p>
            ...
            written notice, and, in doing so, you accept the following conditions:
          </p>
          <ol className={styles['lower-alpha']}>
            <li>
              You are responsible for removing your digital assets from the account prior to close;
            </li>
            <li>
              Any digital assets or other items or information you leave in a closed account may not
              be able to be retrieved, and we disclaim any corresponding liability to you; and
            </li>
            <li>
              Your chosen user credentials will be locked, and you will not be able to use them
          ...
          <p>
            ...
            use of the Site (including blocking certain IP addresses), to any person and for any
            reason, including but not limited to your breach of any representation, warranty, or
            covenant contained in these Terms of Service or violation of any applicable law or
            regulation. If we determine, in our sole discretion, that your use of the Site in any
            way breaches these Terms of Service, violates any applicable law or regulation, poses a
            security risk to our Site or any third party, or potentially subjects us or our
            affiliates to any third-party liability, then we may terminate your use of or
            participation with the Site or delete any of your accounts, User Content, or other
            information, without warning and at our sole discretion. If we terminate or suspend your
          ...
          <p>
            ...
            third party, or potentially subjects us or our affiliates to any third-party liability,
            then we also reserve the right to take appropriate legal action against you, including
            but not limited to pursuing civil, criminal, and injunctive redress, if and as
            applicable. We may investigate and prosecute violations of these Terms of Service to the
            fullest extent permitted by law. We may also notify and cooperate with law enforcement
          ...
          <p>
            ...
            survive termination (including but not limited to Section 4 and Section 8 through 13)
            will survive and remain in full force and effect.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            electronically all notices, disclosures, agreements, and other communications from us
            concerning your use of the Site and your rights and obligations under these Terms of
            Service, and you agree that any means of electronic communication satisfies any legal
            requirement that our communication to you be in writing. To the extent permitted by law,
            you waive any rights or requirements under any statutes, regulations, rules, ordinances,
          ...
          <p>
            ...
            or claims), shall be governed by and construed in accordance with the laws of the Cayman
          ...
          <p>
            ...
            reference only. Headings are not binding and should not be interpreted together with the
            substantive provisions of these Terms of Service or any incorporated documents.
            Additionally, where the text of any provisions of or documents incorporated as part of
            these Terms of Service is bolded, you understand and agree that this text provides you
            with conspicuous notice and satisfies any legal requirement that notices, disclosures,
            or provisions be written in all capital letters.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            finally settled exclusively by binding arbitration in accordance with the United
            Nation’s UNCITRAL Arbitration Rules (at{' '}
            <a
          ...
          <p>
            ...
            intends to seek arbitration must first send to the other party a written Notice of
            Dispute (a “Dispute Notice”). Any Dispute Notice to EcoEarn must be sent{' '}
            <a href="mailto:contact@ecoearn.io" target="_blank" rel="noreferrer">
              here
            </a>
            , and any Dispute Notice we send to you will be sent to the email address registered
            with your account or otherwise associated with your use of the Site and agreement to
            these Terms and Conditions. Dispute Notices must include each of the following: (a) the
            contact details of the party providing the Dispute Notice; (b) a description of the
            nature and basis of the claim or dispute; (c) an explanation of the specific relief
            sought, including the total damages sought, if any, and the basis for the damage
            calculations; (d) a signed statement from the party providing the Dispute Notice
            verifying the accuracy of its contents; and (e) if the dispute is from you and you have
            retained an attorney, then a signed statement from you authorising EcoEarn to disclose
            your account details to your attorney if necessary in resolving your claim or dispute.
            If an agreement is not reached to resolve a claim within 60 days after a notice of
            demand is received, then either party may commence an arbitration proceeding; except
            that, if either you or EcoEarn send the other an incomplete Dispute Notice, the 60-day
            period begins tolling only after a complete Dispute Notice is received. Additionally, if
            either you or EcoEarn request a telephone discussion, the 60-day period begins tolling
            only after the discussion has occurred. The statute of limitations and any filing fee
          ...
          <p>
            ...
            appropriate declaratory and injunctive relief necessary to ensure the arbitration and
            final settlement of disputes (but only in favour of the individual party seeking relief
            and only to the extent necessary to provide relief warranted by that party’s individual
            claim). You and EcoEarn agree to keep any arbitration strictly confidential. The
            properly appointed arbitrator will have the authority to order any remedies, legal or
            equitable, that a party could obtain from a court of competent jurisdiction in an
            individual case based on the claims asserted, and nothing more.
          </p>
        </section>
      </article>
    </div>
