    ...
    <div className={styles.content}>
      <article>
        ...
        <p className="mt-2">
          ...
          when you visit or interact with ecoearn.io {`("Site", "our", "we", or "us")`}.
        </p>
        <p className="mt-2">
          We reserve the right to modify this Privacy Policy periodically, and encourage you to
          regularly review this Privacy Policy to remain informed about our information procedures
          and the choices at your disposal.
        </p>
        <p className="mt-2">
          We are committed to protecting your personal information and your right to privacy. If you
          have any questions or concerns about this privacy policy or our practices with regard to
        ...
        <section className="mt-10">
          ...
          <ul>
            ...
            <li>
              engage with us in other related ways ― including any sales, marketing, or events. In
              this privacy policy, if we refer to:
            </li>
            <li>
            ...
            <li>
              “Services,” we are referring to our Website, and other related services, including any
              sales, marketing, or events.
            </li>
          </ul>
          <p>
            The purpose of this Privacy Policy is to explain to you in the clearest way possible
            what information we collect, how we use it, how we share the information on a need-be
            basis and what rights you have in relation to it. If there are any terms in this Privacy
            Policy that you do not agree with, please discontinue use of our Services immediately.
          </p>
          <p className="mt-2 font-bold text-lg">
            Please read this Privacy Policy carefully, as it will help you understand what we do
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              your information, we will only use that information for the specific reason for which
              it was provided to us. By submitting the information you confirm that you have the
              right to authorise us to process it on your behalf in accordance with this Privacy
              Policy.
            </li>
          </ul>
        </section>
        <section>
          ...
          <p>
            Information you provide to us: We gather information either directly or indirectly from
            you when you interact with us or other sources connected to us. This may include filling
            out forms, making purchases, communicating with us via third-party platforms,
            participating in contests or promotions, seeking customer support, or engaging in other
            forms of communication. The personal information we collect may encompass your name,
            email address, postal address, phone number, credit card details, and any additional
            information you choose to share.
          </p>
          <p className="my-2">General Information we collect from you:</p>
          <ol className={styles['lower-alpha']}>
            <li>
              ...
              <ul className={styles['list-normal']}>
                ...
                <li>
                  ...
                  services, and features you use. The personal information we collect may include
                  the following:
                </li>
                <li>
                  Contact details – We may collect names; phone numbers; email addresses; mailing
                  addresses; contact preferences; and other similar information.
                </li>
              </ul>
              <p>
            ...
            <li>
              ...
              <p>
                Upon accessing our Website or engaging in transactions with us, certain information
                is automatically collected, including:
              </p>
              <ul className={styles['list-normal']}>
                <li>
                  Transactional Information: Details pertaining to purchases or returns, such as
                  product specifications, purchase prices, and transaction dates and locations, are
                  collected.
                </li>
                <li>
                  ...
                  name, information about your activity in the Website (such as the date/time stamps
                  associated with your usage, pages and files viewed, searches and other actions you
                  take such as which features you use) and device event information (such as system
                ...
                <li>
                  ...
                  location data such as, but not limited to the country, location, information about
                  how and when you use our Website and other technical information such as device
                  and application identification numbers, location, browser type, hardware model
                  Internet service provider and/or mobile carrier, operating system and system
                  configuration information. For example, we may use GPS and other technologies to
                  ...
                  device. Note however, if you choose to opt out, you may not be able to use certain
                  aspects of the Services. You have the option to cease the collection of precise
                  location information at any time (refer to the {`"Your Rights and Choices"`}{' '}
            ...
            <li>
              Information we collect from other sources: We may obtain information about you from
              third-party sources, such as identity verification services, data analytics providers,
        ...
        <section>
          ...
          <ul>
            <li>
              To send administrative information to you – to send you product, service and new
              feature information and/or information about changes to our terms, conditions, and
              policies.
            </li>
            <li>
              To protect our Services – as part of our efforts to keep our Website safe and secure
            ...
            <li>
              Fulfill and manage your orders – to fulfill and manage your orders, payments, returns,
              and exchanges made through the Website.
            </li>
            <li>
              Administer prize draws and competitions – to administer prize draws and competitions
              when you elect to participate in our competitions.
            </li>
            <li>
              To deliver and facilitate delivery of services to the user – to provide you with the
              requested service.
            </li>
            <li>
              To respond to user inquiries/offer support to users – to respond to your inquiries and
            ...
            <li>
              ...
              purposes, provided this is in accordance with your marketing preferences. For example,
              when expressing an interest in obtaining information about us or our Website,
            ...
            <li>
              Deliver targeted advertising to you – to develop and display personalized content and
              advertising (and work with third parties who do so) tailored to your interests and/or
        ...
        <section>
          ...
          <p>
            We may process or share your information under the following circumstances or as
            otherwise outlined in this Privacy Policy:
          </p>
          <ul>
            <li>
              Consent – if you have given us specific consent to use your personal information for a
              specific purpose.
            </li>
            <li>
              Legitimate Interests – when it is reasonably necessary to achieve our legitimate
              business interests.
            </li>
            <li>
            ...
            <li>
              Legal Obligations – where we are legally required to do so in order to comply with
              applicable law, governmental requests, a judicial proceeding, court order, or legal
            ...
            <li>
              Vital Interests – where we believe it is necessary to investigate, prevent, or take
              action regarding potential violations of our policies, suspected fraud, situations
              involving potential threats to the safety of any person and illegal activities, or as
              evidence in litigation in which we are involved.
            </li>
          </ul>
          <p>
            More specifically, we may need to process your information or share your personal
          ...
          <ul>
            ...
            <li>
              ...
              to use tracking technology on the Website, which will enable them to collect data on
              our behalf about how you interact with our Website over time. This information may be
              used to, among other things, analyse and track data, determine the popularity of
              certain content, pages or features, and better understand online activity. Unless
              described in this privacy policy , we do not share, sell, rent or trade any of your
        ...
        <section>
          ...
          <p>
            ...
            your consent, please contact us using the contact details provided in section 14 below.
          </p>
          <ul>
        ...
        <section>
          ...
          <p>
            We do not use cookies or tracking technologies. Rather, we utilise anonymous page view
            tracking information provided by third-party analytics providers which do not collect or
            store any personal data. As such, we make no use of cookies.
          </p>
        </section>
        <section>
          <h2>8. Transfer of Information to Other Jurisdictions</h2>
          <p className="mt-2">
            EcoEarn operates and engages service providers in various jurisdictions. Therefore, we
            and our service providers may transfer your personal information to, or store or access
            it in, jurisdictions that may not provide levels of data protection that are equivalent
            to those of your home jurisdiction. By using our Website, you acknowledge and agree to
            such transfers and processing, including to and in the United States. We will take steps
            to ensure that your personal information receives an adequate level of protection in the
          ...
          <ul>
            <li>
              European Commission’s Standard Contractual ClauseWe have implemented measures to
              protect your personal information, including by using the European Commission’s
              Standard Contractual Clauses for transfers of personal information between our group
              ...
              EEA or UK in accordance with European data protection laws and regulations. Our
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            this Privacy Policy will require us keeping your personal information for longer than 2
            years.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            to protect the security of any personal information we collect and process.
          </p>
          <p>However, please remember:</p>
          <ul>
            <li>
              Despite our safeguards and efforts to secure your information, unfortunately no
            ...
            <li>
              Transmission of personal information to and from our Website is at your own risk. You
        ...
        <section>
          ...
          <p>
            ...
            protection laws. These may include the right to :
          </p>
          <ul>
            <li>Request access and obtain a copy of your personal information.</li>
            <li>Request rectification or erasure.</li>
            <li>
              Restrict the processing of your personal information and, if applicable, to data
              portability.
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            to the personal information we collect from you, change that information, have any
            inaccurate information corrected or delete it in some circumstances. To request to
            review, update, or delete your personal information, please contact us on the above
            provided details.
          </p>
        </section>
      </article>
